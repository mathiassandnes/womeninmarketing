export default function Hero() {
  return (
    <section className="relative flex min-h-[90vh] flex-col items-center justify-center bg-gradient-to-br from-brand-blue via-indigo-700 to-brand-purple px-6 text-center overflow-hidden">
      {/* Decorative blob shapes */}
      <div className="absolute top-[-10%] right-[-5%] h-80 w-80 rounded-full bg-brand-purple/40 blur-3xl" />
      <div className="absolute bottom-[-10%] left-[-5%] h-96 w-96 rounded-full bg-brand-pink/25 blur-3xl" />
      <div className="absolute top-[20%] left-[40%] h-[500px] w-[500px] rounded-full bg-brand-pink/15 blur-3xl" />
      <div className="absolute top-[55%] right-[20%] h-72 w-72 rounded-full bg-indigo-400/25 blur-3xl" />
      <div className="absolute bottom-[15%] right-[-10%] h-[420px] w-[420px] rounded-full bg-brand-purple/30 blur-3xl" />
      ...
      <h1 className="relative max-w-4xl font-display text-5xl leading-tight text-white sm:text-6xl md:text-7xl">
        Women in Marketing
      </h1>
      <p className="relative mt-6 max-w-2xl text-xl leading-relaxed text-indigo-200 md:text-2xl">
        Women in Marketing is a community of{" "}
        <strong className="font-bold text-white">real connections</strong>. A{" "}
        <strong className="font-bold text-white">safe space</strong> where
        women in marketing{" "}
        <strong className="font-bold text-white">
          grow, lead, and learn together
        </strong>
        .
      </p>
      <div className="relative mt-10 flex flex-col gap-4 sm:flex-row">
        <a
          href="#community"
          className="rounded-full bg-white px-9 py-4 text-base font-bold text-brand-blue shadow-lg hover:bg-indigo-50 transition-colors"
        >
          Join the Community
        </a>
        <a
          href="#events"
          className="rounded-full border border-white/30 px-9 py-4 text-base font-semibold text-white hover:bg-white/10 transition-colors"
        >
          Explore Events
        </a>
      </div>
